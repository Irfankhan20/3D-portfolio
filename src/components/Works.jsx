    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex gap-2 flex-col justify-end m-3 card-img_hover">
            {/* for frontend github  */}
            <div
              onClick={() => window.open(frontend_github_link, "_blank")}
            ...
            {/* for backend github  */}
            <div
              onClick={() => window.open(backend_github_link, "_blank")}
              className="bg-purple-900 w-10 h-10 rounded-full flex justify-center items-center cursor-pointer"
            >
              <img
                src={github}
